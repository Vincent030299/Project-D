...
public class Astar {
    ...
    public Astar(int rows, int cols, CustomNode initialNode, String productname, int hvCost, int diagonalCost) {
        ...
        products.put("OPPO Find X2 Pro",new CustomNode(11,11));
        products.put("Samsung Galaxy S20 Ultra 5G",new CustomNode(11,11));
        products.put("Samsung Galaxy S20 5G",new CustomNode(11,11));
        products.put("iPhone SE",new CustomNode(11,11));
        products.put("Apple Watch Series 5 Stainless Steel",new CustomNode(11,11));
        products.put("Apple Watch Series 5 Aluminum",new CustomNode(11,11));
        products.put("Samsung Galaxy Watch Active2 44mm Aluminium",new CustomNode(11,11));
        ...
        if(rowd != 0){
            switch(Astar.direction) {
                case "N":
                    if(rowd > 0) {
                        Astar.direction = "N";
                        return("Walk " + Integer.toString(rowd) + " Steps Forward" );
                    } else {
                        Astar.direction = "S";
                        return("Walk " + Integer.toString(rowd *-1) + "Steps Backwards" );
                    }

                case "E":
                    if(rowd > 0) {
                        Astar.direction = "N";
                        return("Walk " + Integer.toString(rowd) + "Steps Left" );
                    } else {
                        Astar.direction = "S";
                        return("Walk " + Integer.toString(rowd * -1) + "Steps Right" );
                    }

                case "S":
                    if(rowd > 0) {
                        Astar.direction = "N";
                        return("Walk " + Integer.toString(rowd) + "Steps Backwards" );
                    } else {
                        Astar.direction = "S";
                        return("Walk " + Integer.toString(rowd * -1) + "Steps Forwards" );
                    }

                case "W":
                    if(rowd > 0) {
                        Astar.direction = "N";
                        return("Walk " + Integer.toString(rowd) + "Steps Right" );
                    } else {
                        Astar.direction = "S";
                        return("Walk " + Integer.toString(rowd * -1) + "Steps Left" );
                    }
            ...
            switch(Astar.direction) {
                case "N":
                    if(cold > 0) {
                        Astar.direction = "E";
                        return("Walk " + Integer.toString(cold) + "Steps Right" );
                    } else {
                        Astar.direction = "W";
                        return("Walk " + Integer.toString(cold* -1) + "Steps Left" );
                    }

                case "E":
                    if(cold > 0) {
                        Astar.direction = "E";
                        return("Walk " + Integer.toString(cold) + "Steps Forward" );
                    } else {
                        Astar.direction = "W";

                        return("Walk " + Integer.toString(cold *-1) + "Steps Backwards" );
                    }

                case "S":
                    if(cold > 0) {
                        Astar.direction = "E";
                        return("Walk " + Integer.toString(cold) + "Steps Left" );
                    } else {
                        Astar.direction = "W";
                        return("Walk " + Integer.toString(cold * -1) + "Steps Right" );
                    }

                case "W":
                    if(cold > 0) {
                        Astar.direction = "E";
                        return("Walk " + Integer.toString(cold) + "Steps Backwards" );
                    } else {
                        Astar.direction = "W";
                        return("Walk " + Integer.toString(cold * -1) + "Steps Forward" );
                    }
